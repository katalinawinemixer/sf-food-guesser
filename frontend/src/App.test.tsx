            ...
            candidates: [
              {
                ...
                sourceUrls: ['https://www.souvla.com/locations/'],
              },
            ],
            ...
            candidates: [
              {
                ...
                sourceUrls: ['https://example.com/wrong-cafe-one'],
              },
              {
                id: '',
                name: 'Wrong Cafe Two',
                ...
                sourceUrls: ['https://example.com/wrong-cafe-two'],
              },
              {
                id: '',
                ...
                sourceUrls: ['https://example.com/wrong-cafe-three'],
              },
            ],
            needsMoreEvidence: true,
          }),
